...
function fundTransfer(from_acno, to_acno, amount) {
    if (validateAccountNumber(from_acno) && validateAccountNumber(to_acno)){
            ...
            if(amount>curBal){
                ...
                console.log(`you acno ${from_acno} account has been debited with ${amount} avl bal ${from_acno_balance} `);
                ...
                console.log(transactions.debitTransactions);
                users[to_acno].transactions.creditTransactions.push(crTrans)
                console.log(transactions.creditTransactions);
